...
- Lee el best_epoch del CSV de entrenamiento (generado por entrenamiento_mlp_nvidia.py).
...
Uso:
    python profiling_mlp_nvidia.py --batch_size 16 --arch MLP-3

IMPORTANTE: Ejecutar DESPUES de entrenamiento_mlp_nvidia.py
"""
...
# CSV de entrada (generado por entrenamiento_mlp_2.py)
...
# =============================================================
#   SPECS DE LA GPU (NVIDIA GeForce GTX TITAN X en felix)
# =============================================================
GPU_SPECS = {
    "gpu_name":           "NVIDIA GeForce GTX TITAN X",
    "gpu_memory_gb":      "12_GDDR5",
    "gpu_architecture":   "Maxwell",
    "cuda_cores":         "3072_cuda_cores",
    "render_cores": 	    "N/A",
    "Reloj_boost":        "1,706 MHz"
}
...
if not os.path.isfile(TRAIN_CSV):
    ...
    print(f"[ERROR] Ejecuta primero: python entrenamiento_mlp_nvidia.py --batch_size {batch} --arch {ARCH_TARGET}")
    sys.exit(1)
